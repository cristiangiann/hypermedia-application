...
\section{Introductory Pages \label{sect:2.1}}
	\subsection{Musical Instruments}
		...
		\newline
		\image{\textheight}{Wireframes/IntrMusicalInstruments.jpg}{Musical Instruments page wireframe}{musical-instruments-wireframe}
	...
	\subsection{Courses}
		...
		\newline
		\image{\textheight}{Wireframes/IntrCourses.jpg}{Courses page wireframe}{courses-wireframe}
	...
	\subsection{Events}
		...
		\newline
		\image{\textheight}{Wireframes/IntrEvents.jpg}{Events page wireframe}{events-wireframe}
